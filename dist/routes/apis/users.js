...
const handlers = __importStar(require("../../handlers/user"));
const authentication_1 = __importDefault(require("../../middleware/authentication"));
const usersRoutes = (0, express_1.Router)();
usersRoutes.get("/", authentication_1.default, handlers.index);
usersRoutes.get("/:userId/account", authentication_1.default, handlers.showUser);
usersRoutes.post("/register", handlers.createUser);
usersRoutes.delete("/:userId/delete", authentication_1.default, handlers.deleteUser);
